...
public class ScheduleUtil {
	...
	public static boolean isMatch(String crontab, Date date){    
        try {    
	 ...
	 * @return
	 */
	public static String toCycleBeginTime(Cycle cycle,Date scheduleDate){
		String ret = null;
		Calendar cal = null;
		switch(cycle){
		case HOURLY:
			ret = DateUtil.format(scheduleDate, "yyyyMMddHH");
			break;
		case DAILY:
			ret = DateUtil.format(scheduleDate, "yyyyMMdd00");
			break;
		case WEEKLY:
